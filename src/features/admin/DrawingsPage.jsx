        ...
        <div className="flex flex-wrap items-center justify-between gap-(--space-3)">
          <div>
            ...
            <div className="shrink-0 w-[clamp(2rem,1.5rem+1.5vw,2.75rem)] h-[clamp(2rem,1.5rem+1.5vw,2.75rem)] rounded-lg bg-linear-to-b from-primary-top to-primary-bottom flex items-center justify-center shadow-[0_4px_12px_var(--color-primary-shadow)]">
              <Layers className="w-(--icon-md) h-(--icon-md) text-white" />
            </div>
            <div className="min-w-0">
              <h1 className="text-(--text-xl) font-bold text-slate-800 leading-tight truncate">Engineering Drawings & Blueprints</h1>
              <p className="text-(--text-xs) text-slate-500 mt-(--space-1) truncate">Centralized repository for Single Line Diagrams (SLD), CAD site maps, feeder layouts & revision approvals.</p>
            </div>
          </div>
          </div>
