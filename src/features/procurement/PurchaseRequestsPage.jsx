        ...
        <div className="flex flex-wrap items-center justify-between gap-(--space-3)">
          <div>
            ...
            <div className="min-w-0">
              <h1 className="text-(--text-xl) font-bold text-slate-800 leading-tight truncate">Purchase Requests</h1>
              <p className="text-(--text-xs) text-slate-500 mt-(--space-1) truncate">View and track all material purchase requests from projects.</p>
            </div>
          </div>
          </div>
        </div>
