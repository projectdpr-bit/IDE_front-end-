...
export const GET_STORE_STOCK_INWARD_MANUAL_API = BASEURL + "store/stock/inward/manual";
export const POST_STORE_STOCK_INWARD_MANUAL_API = BASEURL + "store/stock/inward/manual";
...
export const GET_STORE_VENDORS_API = BASEURL + "store/list/vendors";
